...
- No em dashes. STE bans only the semicolon, so this rule is an addition.
...
- **STE-flavored**: general prose such as READMEs, pull request descriptions, and docs. Apply the sentence, paragraph, active voice, and no phrasal verb discipline. Relax the dictionary lockdown so the text keeps enough range to read naturally.
